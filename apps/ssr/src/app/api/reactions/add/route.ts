...
import { guardDbEnabled, guardGalleryAccess } from '~/lib/api-guard'
import { DbManager } from '~/lib/db'
import { photoLoader } from '~/lib/photo-loader'
import { reactions } from '~/schemas'
import * as schemas from '~/schemas'

export const POST = guardGalleryAccess(
  guardDbEnabled(async (req: NextRequest) => {
...
export const GET = guardGalleryAccess(
  guardDbEnabled(async (req: NextRequest): Promise<NextResponse<AnalysisResponse>> => {
    const db = DbManager.shared.getDb()
